...
LazySegmentTree<ll, ll> seg(
    vector<ll>(n, (1LL << 31) - 1), [](ll x, ll y) { return min(x, y); }, 1e18,
    [](ll x, ll y) { return y == 1e18 ? x : y; }, 1e18, [](ll x, ll y) { return y == 1e18 ? x : y; },
    [](ll y, ll len) { return y; });

// Sum & Add
LazySegmentTree<ll, ll> seg(vector<ll>(n, 0), plus<>(), 0, plus<>(), 0, plus<>(), multiplies<>(), );

// Min & Add
LazySegmentTree<ll, ll> seg(
    vector<ll>(n, 0), [](ll x, ll y) { return min(x, y); }, 1e18, plus<>(), 0, plus<>(),
    [](ll y, ll len) { return y; });

// Sum & Update
LazySegmentTree<ll, ll> seg(
    vector<ll>(n), plus<>(), 0, [](ll x, ll y) { return y == 1e18 ? x : y; }, 1e18,
    [](ll x, ll y) { return y == 1e18 ? x : y; }, [](ll y, ll len) { return y == 1e18 ? 1e18 : y * len; });
...
LazySegmentTree<pll, pll> seg(
    ...
    [](pll y, ll len) {
      return {y.fi, y.se * len};
    }, );

// Range Or & range update
LazySegmentTree<ll, ll> seg(
    vector<ll>(n), [](ll x, ll y) { return x | y; }, 0, [](ll x, ll y) { return y == 1e18 ? x : y; }, 1e18,
    [](ll x, ll y) { return y == 1e18 ? x : y; }, [](ll y, ll len) { return y; });
